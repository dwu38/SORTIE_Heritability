...
// TestLognormalGrowth
//---------------------------------------------------------------------------
#if !defined(TestLognormalGrowth_H)
#define TestLognormalGrowth_H

/**
 * Tests the clLognormalGrowth class. This tests it in all versions - as a
 ...
 * Behaviors:
 * <ul>
 * <li>lognormal growth diam only - applied to species 0 seedlings and species
 * 1 seedlings
 * <li>lognormal growth height only - applied to species 0 saplings and species 1 seedlings
 * <li>constant radial growth - applied to species 0 saplings
 * <li>HeightIncrementer - applied to species 0 seedlings
 * <li> lognormal growth - applied to species 1 saplings
 * </ul>
 *
