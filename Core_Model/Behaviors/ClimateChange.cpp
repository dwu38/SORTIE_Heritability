...
void clClimateChange::GetData(DOMDocument *p_oDoc) {
	try {
		...
		if (m_bIsTemp) {
			...
			FillSingleValue(p_oElement, "sc_climateChangeMinTemp", &m_fMin,
					true);
			FillSingleValue(p_oElement, "sc_climateChangeMaxTemp", &m_fMax,
					true);
			...
			FillSingleValue(p_oElement, "sc_climateChangeMinPrecip", &m_fMin,
					true);
			FillSingleValue(p_oElement, "sc_climateChangeMaxPrecip", &m_fMax,
					true);
			FillSingleValue(p_oElement, "sc_climateChangeOtherPrecip",
					&m_bUpdateAllPrecip, true);
...
void clClimateChange::Action() {
	...
	if (m_bIsTemp) {
		...
		if (m_bUpdateAllPrecip) {
			...
			float fCurrent = p_oPlot->GetMeanAnnualPrecip(), fPropChange =
					(fNewValue - fCurrent) / fCurrent, fSeasPrecip =
					p_oPlot->GetSeasonalPrecipitation();
