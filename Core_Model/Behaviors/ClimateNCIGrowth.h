//---------------------------------------------------------------------------
#ifndef ClimateNCIGrowthH
#define ClimateNCIGrowthH
//---------------------------------------------------------------------------
 ...
 * "Climatencigrowthshell". The XML string is "ClimateNCIGrowth".
 *
...
class clClimateNCIGrowth: virtual public clGrowthBase, clNCIBehaviorBase {
...
public:
	 ...
	 */
	clClimateNCIGrowth(clSimManager *p_oSimManager);
...
protected:
	...
	float (clClimateNCIGrowth::*Adjust)(float fNumber, int iSpecies);
