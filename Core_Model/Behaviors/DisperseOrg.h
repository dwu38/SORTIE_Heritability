 ...
 * distribution functions:  Poisson, normal, lognormal, or negative binomial, or ZeroInflated Poisson.
 *
...
protected:
	...
	*mp_fRandParameter;
	...
	/**
	 ...
	 file is invalid.
	 */
	void GetParameterFileData(clSimManager *p_oSimManager,
	...
	/**
	 * Performs a stochastic adjustment of seed number according to a Zero-inflated Poisson
	 * distribution.
	 * @param fNumber Number of seeds to adjust.
	 * @param iSpecies Species of seed.
	 * @return Number of adjusted seeds.
	 */
	float ZeroInflatedPoissonAdjust(float fNumber, int iSpecies);
