...
void clBrowsedRelativeGrowth::SetNameData(std::string sNameString) {
	try {
		...
		} else if (sNameString.compare("BrowsedRelativeGrowth diam only")
				== 0) {
...
void clBrowsedRelativeGrowth::DoShellSetup(DOMDocument *p_oDoc) {
	...
	try {
		...
		FillSpeciesSpecificValue(p_oElement, "gr_relGrowthDiamExp",
				"gr_rgdeVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
				true);
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
		...
		FillSpeciesSpecificValue(p_oElement, "gr_browsedSlopeGrowthResponse",
				"gr_bsgrVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
				true);
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
		...
		FillSpeciesSpecificValue(p_oElement, "gr_browsedAsympDiameterGrowth",
				"gr_badgVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
				true);
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
		...
		FillSpeciesSpecificValue(p_oElement, "gr_browsedRelGrowthDiamExp",
				"gr_brgdeVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
				true);
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
		...
		for (i = 0; i < m_iNumSpeciesTypeCombos; i++) {
			...
			mp_iBrowsedCodes[mp_whatSpeciesTypeCombos[i].iSpecies][mp_whatSpeciesTypeCombos[i].iType] =
