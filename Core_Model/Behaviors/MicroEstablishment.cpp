  ...
  try {
    ...
    float * p_fSubstrateProportions = new float[number_substrates], //proportions of each type of substrate
        ...
        * p_fFreshLogProportions = new float[m_iMaxRespiteTimesteps + 1], //proportions of different age fresh logs
    	...
    	fSeedParamG1, //paramG1 of seed
		MeanParamG1,
		StDevParamG1,
    	fSeedParamG2, //paramG2 of seed
		MeanParamG2,
		StDevParamG2,
    	fSeedParamM1, //paramM1 of seed
		MeanParamM1,
		StDevParamM1,
		fSeedParamM2, //paramM2 of seed
		MeanParamM2,
		StDevParamM2;
          ...
          for (iSubstr = 0; iSubstr < number_substrates; iSubstr++) {
            ...
            if (mound_freshlogs == iSubstr || ground_freshlogs == iSubstr) {
              ...
              for (j = 0; j < fNumSubstrateSeeds; j++) {
                ...
                MeanParamG1 = p_oPop->GetMeanParamG1(iSpecies);
                StDevParamG1 = p_oPop->GetStDevParamG1(iSpecies);
                fSeedParamG1 = clModelMath::NormalRandomDraw(StDevParamG1) + MeanParamG1;

                //Get a value for fParamG2
                MeanParamG2 = p_oPop->GetMeanParamG2(iSpecies);
                StDevParamG2 = p_oPop->GetStDevParamG2(iSpecies);
                fSeedParamG2 = clModelMath::NormalRandomDraw(StDevParamG2) + MeanParamG2;

                //Get a value for fParamM1
                MeanParamM1 = p_oPop->GetMeanParamM1(iSpecies);
                StDevParamM1 = p_oPop->GetStDevParamM1(iSpecies);
                fSeedParamM1 = clModelMath::NormalRandomDraw(StDevParamM1) + MeanParamM1;
                //Get a value for fParamM2
                MeanParamM2 = p_oPop->GetMeanParamM2(iSpecies);
                StDevParamM2 = p_oPop->GetStDevParamM2(iSpecies);
                ...
                p_oSeedling = p_oPop->CreateTree(fSeedX, fSeedY, iSpecies,
                    clTreePopulation::seedling, 0, fSeedParamG1 , fSeedParamG2, fSeedParamM1 , fSeedParamM2);
