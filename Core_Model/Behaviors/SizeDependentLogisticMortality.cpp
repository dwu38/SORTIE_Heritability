...
// DoShellSetup()
////////////////////////////////////////////////////////////////////////////
void clSizeDependentLogisticMortality::DoShellSetup(
	...
	try {
		...
		short int iNumSpecies = mp_oMortalityOrg->GetNumberOfSpecies(), i; //loop counter
		...
		mp_fMax = new float[iNumSpecies];
		mp_fX0 = new float[iNumSpecies];
		mp_fXb = new float[iNumSpecies];
...
// DoMort()
////////////////////////////////////////////////////////////////////////////
deadCode clSizeDependentLogisticMortality::DoMort(clTree *p_oTree,
	...
	fAnnualDeathProb = mp_fMax[iSpecies]
			/ (1 + pow(fDiam / mp_fX0[iSpecies], mp_fXb[iSpecies]));
