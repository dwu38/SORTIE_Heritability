...
// Constructor
/////////////////////////////////////////////////////////////////////////////*/
clShadedLinearGrowth::clShadedLinearGrowth(clSimManager *p_oSimManager) :
	...
	try {
		...
		if (height_only == m_iGrowthMethod) {
			...
			FillSpeciesSpecificValue(p_oElement,
					"gr_heightShadedLinearIntercept", "gr_hshliVal",
			...
			//Growth slope
			FillSpeciesSpecificValue(p_oElement, "gr_heightShadedLinearSlope",
					"gr_hshlsVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
					true);
			...
			//Shade exponent
			FillSpeciesSpecificValue(p_oElement,
					"gr_heightShadedLinearShadeExp", "gr_hshlseVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);

			//Transfer values to our permanent array
			for (i = 0; i < m_iNumBehaviorSpecies; i++)
				mp_fShader[mp_iIndexes[p_fTempValues[i].code]] =
						p_fTempValues[i].val;
		} else {
			//Growth intercept
			FillSpeciesSpecificValue(p_oElement, "gr_diamShadedLinearIntercept",
					"gr_dshliVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
					true);
			...
			//Growth slope
			FillSpeciesSpecificValue(p_oElement, "gr_diamShadedLinearSlope",
					"gr_dshlsVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
					true);
			...
			//Shade exponent
			FillSpeciesSpecificValue(p_oElement, "gr_diamShadedLinearShadeExp",
					"gr_dshlseVal", p_fTempValues, m_iNumBehaviorSpecies,
					p_oPop, true);
...
/////////////////////////////////////////////////////////////////////////////*/
float clShadedLinearGrowth::CalculateFunctionValue(int iSpecies, float fGLI,
		float fDiam) {
	short int iIndex = mp_iIndexes[iSpecies];

	//Calculate the function value
	return clModelMath::CalcPointValue(fDiam, mp_fSlope[iIndex],
			mp_fIntercept[iIndex]) * pow(fGLI / 100, mp_fShader[iIndex]);
}

//////////////////////////////////////////////////////////////////////////////
// CalcHeightGrowthValue()
/////////////////////////////////////////////////////////////////////////////*/
float clShadedLinearGrowth::CalcHeightGrowthValue(clTree *p_oTree,
...
/////////////////////////////////////////////////////////////////////////////*/
float clShadedLinearGrowth::CalcDiameterGrowthValue(clTree *p_oTree,
