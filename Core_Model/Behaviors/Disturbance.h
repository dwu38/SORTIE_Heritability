...
protected:
	 ...
	 */
	void CutSpeciesAbsDen(int iSp, stcGridList *&p_cutArea, float *p_fLoDbh,
			float *p_fHiDbh, float *p_fAmountToRemove, float *p_fAmountRemoved);
	...
	void CutSpeciesAbsDenPriority(int iSp, stcGridList *&p_cutArea,
			...
			float *p_fAmountRemoved, std::string sPriorityName,
	 ...
	 * @param p_fAmountRemoved Amount already removed.
	 */
	void CutSpeciesAbsBA(int iSp, stcGridList *&p_cutArea, float *p_fLoDbh,
			float *p_fHiDbh, float *p_fAmountToRemove, float *p_fAmountRemoved);
	 ...
	 * @param p_fAmountRemoved Amount already removed.
	 */
	void CutSpeciesPercentDen(int iSp, stcGridList *&p_cutArea, float *p_fLoDbh,
			float *p_fHiDbh, float *p_fAmountToRemove, float *p_fAmountRemoved);
	 ...
	 */
	void CutSpeciesPercentBA(int iSp, stcGridList *&p_cutArea, float *p_fLoDbh,
			float *p_fHiDbh, float *p_fAmountToRemove, float *p_fAmountRemoved,
	...
	void CutSpeciesPercentBAPriority(int iSp, stcGridList *&p_cutArea,
			...
			std::string sPriorityName, int &iPriorityType, float &fPriorityMin,
			float &fPriorityMax);
	...
	int AssembleCutArea(clPackage *p_oMasterPackage, const int &iNumXCells,
			const int &iNumYCells, stcGridList *&p_cutArea, float *p_fLoDbh,
			float *p_fHiDbh, float *p_fAmountToRemove, bool *p_bSpeciesCut);
