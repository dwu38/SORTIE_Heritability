/*
 * JulMaxPrecipMortality.h
 *
 *  Created on: May 14, 2018
 *      Author: ucmuser
 */

#ifndef BEHAVIORS_JULMAXPRECIPMORTALITY_H_
#define BEHAVIORS_JULMAXPRECIPMORTALITY_H_
...
/***
 * JulMaxPrecipMortality
 * This evaluate mortality according to a logistic equation,
 * linking mortality to the actual DBH , competition (NCI), Temp and Water
 * The equation used in this behavior is:
 * <center>p = logit-1(a + b DBH + c DBH2 + d NCI + e Temp + f Water)</center>
 * where
 * <ul>
 ...
 * <li>Temp = actual evapotranspiration </li>
 * <li>Water = climate water deficit </li>
 * <li>NCI is the sum of neighbors DBH/dist</li>
 *
 * </ul>
 *
 * This class's namestring is "JulMaxPrecip mortshell".  The parameter file
 * call string is "JulMaxPrecipMortality".
 *
 */

class clJulMaxPrecipMortality: virtual public clMortalityBase, clNCIBehaviorBase {
...
public:
	 ...
	 */
	clJulMaxPrecipMortality(clSimManager *p_oSimManager);

	/*
	 * Destructor
	 */
	~clJulMaxPrecipMortality();
...
#endif /* BEHAVIORS_JULMAXPRECIPMORTALITY_H_ */
