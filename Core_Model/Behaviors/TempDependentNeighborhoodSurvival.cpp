...
// ReadParameterFile()
////////////////////////////////////////////////////////////////////////////
void clTempDependentNeighborhoodSurvival::ReadParameterFile(
	...
	try {
		...
		stcErr.iErrorCode = UNKNOWN;
		stcErr.sFunction =
				"clTempDependentNeighborhoodSurvival::ReadParameterFile";
		throw(stcErr);
	}
}
...
// DoShellSetup()
////////////////////////////////////////////////////////////////////////////
void clTempDependentNeighborhoodSurvival::DoShellSetup(
...
// GetBAT
////////////////////////////////////////////////////////////////////////////
float clTempDependentNeighborhoodSurvival::GetBAT(float &fX, float &fY,
		clTreePopulation *p_oPop) {
...
// PreMortCalcs
////////////////////////////////////////////////////////////////////////////
void clTempDependentNeighborhoodSurvival::PreMortCalcs(
		clTreePopulation *p_oPop) {
...
void clTempDependentNeighborhoodSurvival::SetupGrid(clTreePopulation *p_oPop) {
	...
	if (NULL == mp_oGrid) {
		...
		mp_oGrid = mp_oSimManager->CreateGrid(
				"Temperature Dependent Neighborhood Survival", 0, //number of ints
		...
		for (i = 0; i < iNumTotalSpecies; i++) {
			...
			if (-1 == mp_iGridSurvivalCodes[i]) {
				modelErr stcErr;
				stcErr.sFunction =
						"clTempDependentNeighborhoodSurvival::SetupGrid";
				std::stringstream s;
			...
			if (-1 == m_iBATCode) {
				...
				stcErr.sFunction =
						"clTempDependentNeighborhoodSurvival::SetupGrid";
				stcErr.sMoreInfo =
						"Couldn't find the \"BAT\" member of the \"Temperature Dependent Neighborhood Survival\" grid.";
				stcErr.iErrorCode = BAD_DATA;
				throw(stcErr);
			}
		}
