...
void clSelfThinMort::DoShellSetup(xercesc::DOMDocument *p_oDoc) {
	try {
		...
		FillSpeciesSpecificValue(p_oElement, "mo_selfThinIntercept",
				"mo_stiVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
				true);
		//Transfer to the appropriate array buckets
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
		...
		FillSpeciesSpecificValue(p_oElement, "mo_selfThinMaxDbh", "mo_stmdVal",
				p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
		//Transfer to the appropriate array buckets
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
...
// DoMort()
////////////////////////////////////////////////////////////////////////////
deadCode clSelfThinMort::DoMort(clTree *p_oTree, const float &fDiam,
	...
	fAnnualDeathProb = clModelMath::CalcPointValue(fDiam,
			mp_fSelfThinSlope[iSpecies], mp_fSelfThinIntercept[iSpecies]);
