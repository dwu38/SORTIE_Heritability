	...
	try {
		...
		if (height_only == m_iGrowthMethod) {
			...
			FillSpeciesSpecificValue(p_oElement,
					"gr_heightSizeDepLogisticIntercept", "gr_hsdliVal",
			...
			//Growth slope
			FillSpeciesSpecificValue(p_oElement,
					"gr_heightSizeDepLogisticSlope", "gr_hsdlsVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
			...
			//Shape parameter 1
			FillSpeciesSpecificValue(p_oElement,
					"gr_heightSizeDepLogisticShape1c", "gr_hsdls1cVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);

			//Transfer values to our permanent array
			for (i = 0; i < m_iNumBehaviorSpecies; i++)
				mp_fShape1[mp_iIndexes[p_fTempValues[i].code]] =
						p_fTempValues[i].val;

			//Shape parameter 2
			FillSpeciesSpecificValue(p_oElement,
					"gr_heightSizeDepLogisticShape2d", "gr_hsdls2dVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);

			//Transfer values to our permanent array
			for (i = 0; i < m_iNumBehaviorSpecies; i++)
				mp_fShape2[mp_iIndexes[p_fTempValues[i].code]] =
						p_fTempValues[i].val;

		} else {
			//Growth intercept
			FillSpeciesSpecificValue(p_oElement,
					"gr_diamSizeDepLogisticIntercept", "gr_dsdliVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
			...
			//Growth slope
			FillSpeciesSpecificValue(p_oElement, "gr_diamSizeDepLogisticSlope",
					"gr_dsdlsVal", p_fTempValues, m_iNumBehaviorSpecies, p_oPop,
					true);
			...
			//Shape parameter 1
			FillSpeciesSpecificValue(p_oElement,
					"gr_diamSizeDepLogisticShape1c", "gr_dsdls1cVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
			...
			//Shape parameter 2
			FillSpeciesSpecificValue(p_oElement,
					"gr_diamSizeDepLogisticShape2d", "gr_dsdls2dVal",
					p_fTempValues, m_iNumBehaviorSpecies, p_oPop, true);
...
void clSizeDepLogisticGrowth::SetNameData(std::string sNameString) {
	try {
		...
		} else if (sNameString.compare("SizeDependentLogisticGrowth diam only")
				== 0) {
			m_iGrowthMethod = diameter_only;
		} else if (sNameString.compare(
				"SizeDependentLogisticGrowth height only") == 0) {
...
/////////////////////////////////////////////////////////////////////////////*/
float clSizeDepLogisticGrowth::CalculateFunctionValue(int iSpecies, float fGLI,
		float fDiam) {
