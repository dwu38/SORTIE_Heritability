...
void clPlant::PlantTrees(clPackage *p_oMasterPackage) {
 try {
   ...
   float *p_fAmountToPlant, //amount of each species to plant
		 ...
		 fParamG1, // paramG1 of the new seedling
		 fParamG2, // paramG2 of the new seedling
		 fParamM1, // paramM1 of the new seedling
		 fParamM2, // paramM2 of the new seedling
		 MeanParamG1,
		 MeanParamG2,
		 MeanParamM1,
		 MeanParamM2,
   ...
   if (random == iSpaceType) {
     ...
     for (fTree = 0; fTree < fNumTotalTrees; fTree++) {
       ...
       //Get a value for fParamG1
       MeanParamG1 = mp_oPop->GetMeanParamG1(iSp);
       StDevParamG1 = mp_oPop->GetStDevParamG1(iSp);
       fParamG1 = clModelMath::NormalRandomDraw(StDevParamG1) + MeanParamG1;

       //Get a value for fParamG2
       MeanParamG2 = mp_oPop->GetMeanParamG2(iSp);
       StDevParamG2 = mp_oPop->GetStDevParamG2(iSp);
       fParamG2 = clModelMath::NormalRandomDraw(StDevParamG2) + MeanParamG2;

       //Get a value for fParamM1
       MeanParamM1 = mp_oPop->GetMeanParamM1(iSp);
       StDevParamM1 = mp_oPop->GetStDevParamM1(iSp);
       fParamM1 = clModelMath::NormalRandomDraw(StDevParamM1) + MeanParamM1;

       //Get a value for fParamM2
       MeanParamM2 = mp_oPop->GetMeanParamM2(iSp);
       StDevParamM2 = mp_oPop->GetStDevParamM2(iSp);
       fParamM2 = clModelMath::NormalRandomDraw(StDevParamM2) + MeanParamM2;

       //Plant our new seedling
       mp_oPop->CreateTree(fX, fY, iSp, clTreePopulation::seedling, fDiam10,fParamG1,fParamG2,fParamM1,fParamM2);
