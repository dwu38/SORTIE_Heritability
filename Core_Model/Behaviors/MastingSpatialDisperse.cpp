...
///////////////////////////////////////////////////////////////////////////////
void clMastingSpatialDisperse::GetParameterFileData(
	...
	try {
		...
		for (i = 0; i < m_iNumBehaviorSpecies; i++)
			if (p_iTemp[i].val != weibull && p_iTemp[i].val != lognormal
				...
				stcErr.iErrorCode = BAD_DATA;
				stcErr.sFunction =
						"clMastingSpatialDisperse::GetParameterFileData";
				std::stringstream s;
...
/////////////////////////////////////////////////////////////////////////////
void clMastingSpatialDisperse::CalculateProbabilityDistribution(
...
void clMastingSpatialDisperse::SetGetSeedsFunctionPointers() {
	...
	for (i = 0; i < m_iNumBehaviorSpecies; i++) {
		if (deterministic_pdf == mp_iWhatPDFForSTR[i]
			...
			mp_GetSeeds[i] =
					&clMastingSpatialDisperse::GetNumberOfSeedsDrawNormal;
		} else if (lognormal_pdf == mp_iWhatPDFForSTR[i]) {
			mp_GetSeeds[i] =
					&clMastingSpatialDisperse::GetNumberOfSeedsDrawLognormal;
		} else {
			mp_GetSeeds[i] = &clMastingSpatialDisperse::GetNumberOfSeedsDrawZIP;
		}
	}
...
///////////////////////////////////////////////////////////////////////////////
float clMastingSpatialDisperse::GetNumberOfSeedsDrawZIP(const float &fDbh,
		const short int &iSp) {
