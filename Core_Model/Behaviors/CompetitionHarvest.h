...
protected:
	 ...
	 */
	void RecalculateCOESpeciesSpecific(clTreePopulation *p_oPop,
	 ...
	 * @param fY Y coordinate of tree that was removed.
	 */
	void RecalculateCOENotSpeciesSpecific(clTreePopulation *p_oPop,
			const float &fX, const float &fY);
	 ...
	 */
	float CalculateOneCOE(clPlot *p_oPlot, clTreePopulation *p_oPop,
			clTree *p_oTree);
};
//---------------------------------------------------------------------------
#endif
