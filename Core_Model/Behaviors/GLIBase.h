...
protected:
	 ...
	 * @param p_oAllom Pointer to an allometry object
	 */
	void GLIFisheyeNoCanopyIntersect(const float &fTargetX,
	 ...
	 * @param p_oAllom Pointer to an allometry object
	 */
	void GLIFisheyeCanopyIntersect(const float &fTargetX, const float &fTargetY,
			const float &fNeighX, const float &fNeighY,
			const float &fNeighCanrad, const float &fNeighHeight,
			const short int &iNeighSpecies, const float &fTargetHeight,
