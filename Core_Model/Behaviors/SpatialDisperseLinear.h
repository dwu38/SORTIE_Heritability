/*
 * SpatialDisperseLinear.h
 *
 *  Created on: Dec 2, 2016
 *      Author: ucmuser
 */

#ifndef BEHAVIORS_SPATIALDISPERSELINEAR_H_
#define BEHAVIORS_SPATIALDISPERSELINEAR_H_
...
/**
 * Spatial dispersal linear - Version 1.0
 *
 ...
 * according
 * to either the Weibull or Lognormal or 2DT probability distribution functions.
 *
 ...
 */
class clSpatialDispersalLinear: virtual public clDisperseBase {
...
public:
	 ...
	 */
	clSpatialDispersalLinear(clSimManager *p_oSimManager);

	/**
	 * Destructor.
	 */
	~clSpatialDispersalLinear();
...
protected:
	 ...
	 */
	void SpatialDisperse(clTree *p_oTree, clTreePopulation *p_oPop,
			clPlot *p_oPlot, float fDbh);
	 ...
	 * @param p_oPop Tree Population object
	 */
	void NonSpatialDisperse(clTree *p_oTree, clTreePopulation *p_oPop,
			clPlot *p_oPlot, float fDbh);
...
#endif /* BEHAVIORS_SPATIALDISPERSELINEAR_H_ */
