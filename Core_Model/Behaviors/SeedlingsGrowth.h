...
#ifndef BEHAVIORS_SEEDLINGSGROWTH_H_
#define BEHAVIORS_SEEDLINGSGROWTH_H_
...
class clSeedlingsGrowth: virtual public clGrowthBase {
...
public:
	 ...
	 */
	clSeedlingsGrowth(clSimManager *p_oSimManager);
...
#endif /* BEHAVIORS_SEEDLINGSGROWTH_H_ */
