...
void clEstablishment::Action()
{
  try
  {
	...
	fSeedParamG1, //paramG1 of the seed
	MeanParamG1,
	StDevParamG1,
	fSeedParamG2, //paramG2 of the seed
	MeanParamG2,
	StDevParamG2,
	fSeedParamM1, //paramM1 of the seed
	MeanParamM1,
	StDevParamM1,
	fSeedParamM2, //paramM2 of the seed
	MeanParamM2,
	StDevParamM2,
      ...
      for ( iY = 0; iY < iNumYCells; iY++ )
      {
        ...
        for ( i = 0; i < m_iNumBehaviorSpecies; i++ )
        {
          ...
          for ( j = 0; j < fNumSeeds; j++ )
          {
            ...
            //Get a value for fParamG1 for the seed
            MeanParamG1 = p_oPop->GetMeanParamG1(iSp);
            StDevParamG1 = p_oPop->GetStDevParamG1(iSp);
            fSeedParamG1 = clModelMath::NormalRandomDraw(StDevParamG1) + MeanParamG1;

            //Get a value for fParamG2 for the seed
            MeanParamG2 = p_oPop->GetMeanParamG2(iSp);
            StDevParamG2 = p_oPop->GetStDevParamG2(iSp);
            fSeedParamG2 = clModelMath::NormalRandomDraw(StDevParamG2) + MeanParamG2;

            //Get a value for fParamM1 for the seed
            MeanParamM1 = p_oPop->GetMeanParamM1(iSp);
            StDevParamM1 = p_oPop->GetStDevParamM1(iSp);
            fSeedParamM1 = clModelMath::NormalRandomDraw(StDevParamM1) + MeanParamM1;

            //Get a value for fParamM2 for the seed
            MeanParamM2 = p_oPop->GetMeanParamM2(iSp);
            StDevParamM2 = p_oPop->GetStDevParamM2(iSp);
            fSeedParamM2 = clModelMath::NormalRandomDraw(StDevParamM2) + MeanParamM2;

            //Create the new seedling - allow a random diameter at 10 cm
            p_oPop->CreateTree( fSeedX, fSeedY, iSp, clTreePopulation::seedling, 0, fSeedParamG1, fSeedParamG2, fSeedParamM1, fSeedParamM2 );
