...
/////////////////////////////////////////////////////////////////////////////
void clBehaviorBase::SetSpeciesTypeCombos(short int iNumCombos,
	...
	try {
		...
		if (0 >= m_iNumSpeciesTypeCombos) {
			...
			//Otherwise - problem - throw error
				...
				stcErr.sMoreInfo =
						"Number of combos doesn't match species/type combo list.";
				throw(stcErr);
			}
		...
		mp_whatSpeciesTypeCombos =
				new stcSpeciesTypeCombo[m_iNumSpeciesTypeCombos];
...
// GetSpeciesTypeCombo()
//////////////////////////////////////////////////////////////////////////////
struct stcSpeciesTypeCombo clBehaviorBase::GetSpeciesTypeCombo(
		short int iIndex) {
	...
	if (iIndex < 0 || iIndex >= m_iNumSpeciesTypeCombos) {
		...
		std::stringstream s;
		s << "Index \"" << iIndex
				<< "\" is not a valid species/type combo index.";
		stcErr.sMoreInfo = s.str();
		throw(stcErr);
	} else
		return (mp_whatSpeciesTypeCombos[iIndex]);
}
...
/////////////////////////////////////////////////////////////////////////////
DOMElement* clBehaviorBase::GetParentParametersElement(
