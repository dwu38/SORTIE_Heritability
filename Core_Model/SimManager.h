...
public:
	 ...
	 */
	clSimManager(int iMajorVersion, int iMinorVersion,
	 ...
	 */
	enum simState {
		No_Data, /**<Object managers are created but have no objects -
	...
	clGrid* CreateGrid(std::string sGridName, short int iNumIntVals,
			...
			short int iNumBoolVals, float fXCellLength = 0, float fYCellLength =
					0);
