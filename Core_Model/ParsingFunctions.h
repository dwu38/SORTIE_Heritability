...
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, floatVal *p_array,
		int iNumSpecies, clTreePopulation *p_oPop, bool bRequired);
 ...
 */
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, doubleVal *p_array,
		int iNumSpecies, clTreePopulation *p_oPop, bool bRequired);
 ...
 */
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, intVal *p_array,
		int iNumSpecies, clTreePopulation *p_oPop, bool bRequired);
 ...
 */
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, boolVal *p_array,
		int iNumSpecies, clTreePopulation *p_oPop, bool bRequired);
 ...
 */
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, float *p_fArray,
 ...
 */
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, double *p_fArray,
		clTreePopulation *p_oPop, bool bRequired);
 ...
 */
void FillSpeciesSpecificValue(xercesc::DOMElement *p_oParent,
		std::string sTagName, std::string sSubTagName, int *p_iArray,
		clTreePopulation *p_oPop, bool bRequired);
