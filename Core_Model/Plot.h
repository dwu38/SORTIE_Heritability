...
public:
	...
	/**
	 * Gets the maximum temperature of July.
	 * @return maximum July temperature, in degrees C.
	 */
	float GetJulMaxTemp() {
		return m_fJMxTemp;
	}
	...
	/**
	 * Sets the maximum July temperature.
	 * @param fJMxTemp July max temperature, in degrees C.
	 */
	void SetJulMaxTemp(float fJMxTemp) {
		m_fJMxTemp = fJMxTemp;
	}
	;

	/**
	 * Gets the minimum temperature of January.
	 * @return minimum January temperature, in degrees C.
	 */
	float GetJanMinTemp() {
		return m_fJMnTemp;
	}
	...
	/**
	 * Sets the minimum temperature of January.
	 * @param fJMnTemp January minimum temperature, in degrees C.
	 */
	void SetJanMinTemp(float fJMnTemp) {
		m_fJMnTemp = fJMnTemp;
	}
	;

	/**
	 * Gets the annual snow precipitation.
	 * @return Annual snow.
	 */
	float GetAnnualSnow() {
		return m_fSnow;
	...
	/**
	 * Sets the annual snow precipitation.
	 * @param fSnow Annual snow precipitation.
	 */
	void SetAnnualSnow(float fSnow) {
		m_fSnow = fSnow;
	}
	;

	/**
	 * Gets the annual AET (actual evapotranspiration).
	 * @return Annual AET.
	 */
	float GetAET() {
		return m_fAET;
	...
	/**
	 * Sets the annual AET (actual evapotranspiration).
	 * @param fAET Annual AET.
	 */
	void SetAET(float fAET) {
		m_fAET = fAET;
	}
	;

	/**
	 * Gets the annual ASpck (April snow pack).
	 * @return Annual ASpck.
	 */
	float GetASpck() {
		return m_fASpck;
	...
	/**
	 * Sets the annual ASpck (April snow pack).
	 * @param fASpck Annual ASpck.
	 */
	void SetASpck(float fASpck) {
		m_fASpck = fASpck;
	}
	;
	...
	float GetGridCellArea() {
		return m_iCellSize * m_iCellSize;
	}
	;
...
//  };
	/**
	 * Gets the distance between two points in the X plane, changed to avoid the torus conditions
	 *
	 * @param fFromX X coordinate of the "from" point.
	 * @param fToX X coordinate of the "to" point.
	 * @return X distance in meters.
...
//  }
	/**
	 * Gets the distance between two points in the Y plane,  changed to avoid the torus conditions
	 *
	 * @param fFromY Y coordinate of the "from" point.
	 * @param fToY Y coordinate of the "to" point.
	 * @return Y distance in meters.
...
protected:
	...
	float m_fMeanAnnualTempC;

	/**Annual N deposition.*/
	float m_fNDep;

	/**Annual july max temperature.*/
	float m_fJMxTemp;

	/**Annual January min temperature.*/
	float m_fJMnTemp;

	/**Annual snow precipitation.*/
	float m_fSnow;
