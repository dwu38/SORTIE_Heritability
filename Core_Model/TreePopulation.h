...
*
*
* Modification for the Sierra Nevada project (Emily Moran lab, Melaine AK)
* 2017: modified to take ParamG1 into account: a parameter that is attributed to each tree and doesnt change
* other parameters: ParamG2, ParamM1 and ParamM2
*
* 2017: modified to allow the MeanParam to change: addition of the public method SetMeanParamG1
* and for other parameters: SetMeanParamG2, SetMeanParamM1 and SetMeanParamM2
*
* 2023-24: modified to incorporate heritability for ParamG1, ParamG2, ParamM1, ParamM2 (Emily Moran lab, Dean Wu)
*
*
*
*
...
class clTreePopulation : public clPopulationBase {
  ...
  * </ul>
  */
  clTree* CreateTree(float fX, float fY, int iSp, int iType, float fDiam, float fParamG1, float fParamG2, float fParamM1, float fParamM2);
  ...
  */
  ...
  /**
  * Gets the code for the "ParamG1" data member, which is registered by the tree
  * population.
  * @param iSpecies The species.
  * @param iType The tree type.
  * @return Data member code.
  * @throw Error if given bad species or type codes.
  */
  short int GetParamG1Code(int iSpecies, int iType);

  /**
  * Gets the code for the "ParamG2" data member, which is registered by the tree
  * population.
  * @param iSpecies The species.
  * @param iType The tree type.
  * @return Data member code.
  * @throw Error if given bad species or type codes.
  */
  short int GetParamG2Code(int iSpecies, int iType);

  /**
  * Gets the code for the "ParamM1" data member, which is registered by the tree
  * population.
  * @param iSpecies The species.
  * @param iType The tree type.
  * @return Data member code.
  * @throw Error if given bad species or type codes.
  */
  short int GetParamM1Code(int iSpecies, int iType);

  /**
  * Gets the code for the "ParamM2" data member, which is registered by the tree
  * population.
  * @param iSpecies The species.
  * @param iType The tree type.
  * @return Data member code.
  * @throw Error if given bad species or type codes.
  */
  short int GetParamM2Code(int iSpecies, int iType);
  ...
  */
  ...
  /**
  * Gets the code for the "SizeClass" data member, which is registered by the tree
  * population.
  * @param iSpecies The species.
  * @param iType The tree type.
  * @return Data member code.
  * @throw Error if given bad species or type codes.
  */
  short int GetSizeClassCode(int iSpecies, int iType);
  ...
  */
  ...
  /**
  * Gets the mean value of ParamG1, part of the parameter ParamG1 that is shared by all trees of the same species.
  *
  * @param iSpecies Species for which to get the mean ParamG1.
  * @return mean ParamG1.
  * @throw Error if the species isn't valid.
  */
  float GetMeanParamG1(int iSpecies);

  /**
  * Gets the mean value of ParamG2, part of the parameter ParamG2 that is shared by all trees of the same species.
  *
  * @param iSpecies Species for which to get the mean ParamG2.
  * @return mean ParamG2.
  * @throw Error if the species isn't valid.
  */
  float GetMeanParamG2(int iSpecies);

  /**
  * Gets the mean value of ParamM1, part of the parameter ParamM1 that is shared by all trees of the same species.
  *
  * @param iSpecies Species for which to get the mean ParamM1.
  * @return mean ParamM1.
  * @throw Error if the species isn't valid.
  */
  float GetMeanParamM1(int iSpecies);

  /**
  * Gets the mean value of ParamM2, part of the parameter ParamM2 that is shared by all trees of the same species.
  *
  * @param iSpecies Species for which to get the mean ParamM2.
  * @return mean ParamM2.
  * @throw Error if the species isn't valid.
  */
  float GetMeanParamM2(int iSpecies);

  /**
  * Sets the mean value of ParamG1, part of the parameter ParamG1 that is shared by all trees of the same species.
  * Because MeanParamG1 needs to change over time
  *
  * @param iSpecies Species for which to get the mean ParamG1.
  * @return mean ParamG1.
  * @throw Error if the species isn't valid.
  */
  void SetMeanParamG1(int iSpecies, float fNewMeanParamG1);

  /**
  * Sets the mean value of ParamG2, part of the parameter ParamG2 that is shared by all trees of the same species.
  * Because MeanParamG2 needs to change over time
  *
  * @param iSpecies Species for which to get the mean ParamG2.
  * @return mean ParamG2.
  * @throw Error if the species isn't valid.
  */
  void SetMeanParamG2(int iSpecies, float fNewMeanParamG2);

  /**
  * Sets the mean value of ParamM1, part of the parameter ParamM1 that is shared by all trees of the same species.
  * Because MeanParamM1 needs to change over time
  *
  * @param iSpecies Species for which to get the mean ParamM1.
  * @return mean ParamM1.
  * @throw Error if the species isn't valid.
  */
  void SetMeanParamM1(int iSpecies, float fNewMeanParamM1);

  /**
  * Sets the mean value of ParamM2, part of the parameter ParamM2 that is shared by all trees of the same species.
  * Because MeanParamM2 needs to change over time
  *
  * @param iSpecies Species for which to get the mean ParamM2.
  * @return mean ParamM2.
  * @throw Error if the species isn't valid.
  */
  void SetMeanParamM2(int iSpecies, float fNewMeanParamM2);

  /**
  * Gets the standard deviation value of ParamG1.
  *
  * @param iSpecies Species for which to get the deviation for ParamG1.
  * @return standard deviation for ParamG1.
  * @throw Error if the species isn't valid.
  */
  float GetStDevParamG1(int iSpecies);

  /**
  * Gets the standard deviation value of ParamG2.
  *
  * @param iSpecies Species for which to get the deviation for ParamG2.
  * @return standard deviation for ParamG2.
  * @throw Error if the species isn't valid.
  */
  float GetStDevParamG2(int iSpecies);

  /**
  * Gets the standard deviation value of ParamM1.
  *
  * @param iSpecies Species for which to get the deviation for ParamM1.
  * @return standard deviation for ParamM1.
  * @throw Error if the species isn't valid.
  */
  float GetStDevParamM1(int iSpecies);

  /**
  * Gets the standard deviation value of ParamM2.
  *
  * @param iSpecies Species for which to get the deviation for ParamM2.
  * @return standard deviation for ParamM2.
  * @throw Error if the species isn't valid.
  */
  float GetStDevParamM2(int iSpecies);

  /**
  * Gets the narrow-sense heritability value of ParamG1.
  *
  * @param iSpecies Species for which to get the heritability for ParamG1.
  * @return narrow-sense heritability for ParamG1.
  * @throw Error if the species isn't valid.
  */
  float GetNSHeritParamG1(int iSpecies);

  /**
  * Gets the narrow-sense heritability value of ParamG2.
  *
  * @param iSpecies Species for which to get the heritability for ParamG2.
  * @return narrow-sense heritability for ParamG2.
  * @throw Error if the species isn't valid.
  */
  float GetNSHeritParamG2(int iSpecies);

  /**
  * Gets the narrow-sense heritability value of ParamM1.
  *
  * @param iSpecies Species for which to get the heritability for ParamM1.
  * @return narrow-sense heritability for ParamM1.
  * @throw Error if the species isn't valid.
  */
  float GetNSHeritParamM1(int iSpecies);

  /**
  * Gets the narrow-sense heritability value of ParamM2.
  *
  * @param iSpecies Species for which to get the heritability for ParamM2.
  * @return narrow-sense heritability for ParamM2.
  * @throw Error if the species isn't valid.
  */
  float GetNSHeritParamM2(int iSpecies);
...
///////////////////////////////////////////////////////////////////////////
  ...
  float *mp_fMinAdultDbh; /**<Minimum adult DBH, in cm, for each species.
        From parameter file.*/
  float *mp_fMeanParamG1; /**< Common part of the ParamG1, for each species*/
  float *mp_fMeanParamG2; /**< Common part of the ParamG2, for each species*/
  float *mp_fMeanParamM1; /**< Common part of the ParamM1, for each species*/
  float *mp_fMeanParamM2; /**< Common part of the ParamM2, for each species*/
  float *mp_fStDevParamG1; /**< standard deviation of the ParamG1, for each species*/
  float *mp_fStDevParamG2; /**< standard deviation of the ParamG2, for each species*/
  float *mp_fStDevParamM1; /**< standard deviation of the ParamM1, for each species*/
  float *mp_fStDevParamM2; /**< standard deviation of the ParamM2, for each species*/

  float *mp_fNSHeritParamG1; /**< narrow-sense heritability of the ParamG1, for each species*/
  float *mp_fNSHeritParamG2; /**< narrow-sense heritability of the ParamG2, for each species*/
  float *mp_fNSHeritParamM1; /**< narrow-sense heritability of the ParamM1, for each species*/
  float *mp_fNSHeritParamM2; /**< narrow-sense heritability of the ParamM2, for each species*/
  ...
  short int **mp_iDiam10Code; /**<Codes for "Diam10" tree data member. Array size is
        number of species by number of types.*/
  short int **mp_iSizeClassCode; /**<Codes for "Size class" tree data member. Array size is
        number of species by number of types.*/
  short int **mp_iDbhCode;  /**<Codes for "DBH" tree data member. Array size is
        number of species by number of types.*/
  short int **mp_iParamG1Code;  /**<Codes for "ParamG1" tree data member. Array size is
        number of species by number of types.*/
  short int **mp_iParamG2Code;  /**<Codes for "ParamG2" tree data member. Array size is
        number of species by number of types.*/
  short int **mp_iParamM1Code;  /**<Codes for "ParamM1" tree data member. Array size is
        number of species by number of types.*/
  short int **mp_iParamM2Code;  /**<Codes for "ParamM2" tree data member. Array size is
        number of species by number of types.*/
  ...
  */
  void UpdateTree(clTree *p_oTree, short int iCode, int iValue, bool bUpdateNow, bool bUpdateAllometry);
