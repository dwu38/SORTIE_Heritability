...
public:
	 ...
	 */
	void ChangePackageDataStructure(short int iNumIntVals,
			short int iNumFloatVals, short int iNumStringVals,
	 ...
	 * not valid.
	 */
	void GetValueAtPoint(float fX, float fY, short int iCode,
			int *p_iValHolder);
	 ...
	 * or the code is not valid.
	 */
	void GetValueOfCell(int iX, int iY, short int iCode,
			std::string *p_sValHolder);
	 ...
	 * @return The average specified.
	 */
	float GetAverageFloatValue(float fX, float fY, short int iCode,
			float fRadius);
	 ...
	 * @return The average specified.
	 */
	float GetAverageIntValue(float fX, float fY, short int iCode,
			float fRadius);
	 ...
	 * point coordinates.
	 */
	float GetAverageFloatValue(float fFromX, float fFromY, float fToX,
	 ...
	 * point coordinates.
	 */
	float GetAverageIntValue(float fFromX, float fFromY, float fToX, float fToY,
			short int iCode);
	 ...
	 */
	void GetPointOfCell(short int iCellX, short int iCellY, float *fX,
			float *fY);
	 ...
	 */
	void GetCellOfPoint(float fX, float fY, short int *iCellX,
			short int *iCellY);
	...
	int GetNumberStringPackageDataMembers() {
		return m_iNumPackageStringVals;
	}
	;
	 ...
	 * not valid.
	 */
	void SetValueAtPoint(float fX, float fY, short int iCode,
			std::string sValue);
