...
*****************************************************************************
  ...
  This DLL contains everything for interfacing the model with the command line.
 ...
 * discovered.
 * @param sAppPath Path to the application. Ignored in this version of the dll.
*/
__INTERFACE_EXPORT_TYPE modelMsg CheckForMessage(std::string sAppPath);
